...
var verifiedSelectionEpisodes = map[selectionEpisodeKey]selectionEpisodeTarget{
	...
	// ゆるゆり せれくしょん: Shoboi TIDs 2193, 2567, and 3884.
	selectionKey("ゆるゆり せれくしょん", 1, "2022-08-23"):  {"ゆるゆり", 12, "みんなでポカポカ合宿へ"},
	selectionKey("ゆるゆり せれくしょん", 2, "2022-08-23"):  {"ゆるゆり さん☆ハイ！", 2, "さぁおびえるがいい"},
	selectionKey("ゆるゆり せれくしょん", 3, "2022-08-30"):  {"ゆるゆり さん☆ハイ！", 4, "その夜は、みんなの想いをつないでゆく。"},
	selectionKey("ゆるゆり せれくしょん", 4, "2022-08-30"):  {"ゆるゆり", 6, "あーと☆あーたー☆あーちすと"},
	selectionKey("ゆるゆり せれくしょん", 5, "2022-09-06"):  {"ゆるゆり♪♪", 5, "日本の夏 ゆるめの夏"},
	selectionKey("ゆるゆり せれくしょん", 6, "2022-09-06"):  {"ゆるゆり", 7, "くり済ませり"},
	selectionKey("ゆるゆり せれくしょん", 7, "2022-09-13"):  {"ゆるゆり さん☆ハイ！", 7, "忘れられない一日になる"},
	selectionKey("ゆるゆり せれくしょん", 8, "2022-09-13"):  {"ゆるゆり", 3, "ウチくる!? …いくいくっ！"},
	selectionKey("ゆるゆり せれくしょん", 9, "2022-09-20"):  {"ゆるゆり♪♪", 11, "時をかけるあかり"},
	selectionKey("ゆるゆり せれくしょん", 10, "2022-09-20"): {"ゆるゆり", 1, "中学デビュー！"},
	selectionKey("ゆるゆり せれくしょん", 11, "2022-09-27"): {"ゆるゆり♪♪", 8, "ちなつ無双"},
	selectionKey("ゆるゆり せれくしょん", 12, "2022-09-27"): {"ゆるゆり", 5, "あかりとかミンミンゼミとかなく頃に"},
}
