...
func TestParseFilename(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name:      "generic anime EPG bare number and subtitle",
			input:     "アニメ 天は赤い河のほとり 09 手のひらのしるし (20260903).mp4",
			wantTitle: "天は赤い河のほとり",
			wantEp:    9,
			wantSub:   "手のひらのしるし",
		},
		{
			name:      "generic anime EPG final episode with unquoted subtitle",
			input:     "アニメ HUNTER×HUNTER[終] 第148話 コレマデ×ト×コレカラ (20260903).mp4",
			wantTitle: "HUNTER×HUNTER",
			wantEp:    148,
			wantSub:   "コレマデ×ト×コレカラ",
		},
		{
			name:      "generic anime EPG season suffix and bare number",
			input:     "アニメ ヘルモード ~やり込み好きのゲーマーは廃設定の異世界で無双する~2 21 (20260830).mp4",
			wantTitle: "ヘルモード ~やり込み好きのゲーマーは廃設定の異世界で無双する~2",
			wantEp:    21,
		},
		{
			name:      "bare positional number without anime EPG prefix stays in title",
			input:     "作品 09 手のひらのしるし (20260903).mp4",
			wantTitle: "作品 09 手のひらのしるし",
		},
		{
			name:      "single digit positional field stays in generic anime title",
			input:     "アニメ 作品 9 手のひらのしるし (20260903).mp4",
			wantTitle: "作品 9 手のひらのしるし",
		},
		{
			name:      "positional candidate before explicit episode marker is ignored",
			input:     "アニメ 作品 09 第10話「正しい話数」 (20260903).mp4",
			wantTitle: "作品 09",
			wantEp:    10,
			wantSub:   "正しい話数",
		},
		{
			name:      "old formal kanji episode number",
			input:     "二十世紀電氣目録-ユーレカ・エヴリカ- 第拾壹話「誘う回路」 (20260913).mp4",
			wantTitle: "二十世紀電氣目録-ユーレカ・エヴリカ-",
			wantEp:    11,
			wantSub:   "誘う回路",
		},
		{
